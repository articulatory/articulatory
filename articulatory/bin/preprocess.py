...
from articulatory.datasets import AudioDataset
from articulatory.datasets import AudioSCPDataset
from articulatory.datasets import ArtSCPDataset
from articulatory.utils import write_hdf5
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Preprocess audio and then extract features (See detail in articulatory/bin/preprocess.py)."
    )
    parser.add_argument(
        "--wav-scp",
        "--scp",
