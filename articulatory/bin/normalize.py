...
from articulatory.datasets import AudioMelDataset
from articulatory.datasets import AudioMelSCPDataset
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Normalize dumped raw features (See detail in articulatory/bin/normalize.py)."
    )
    parser.add_argument(
        "--rootdir",
        default=None,
