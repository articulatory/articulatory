...
from articulatory.nets.pytorch_backend.transformer.decoder_layer import DecoderLayer
...
from articulatory.nets.scorer_interface import BatchScorerInterface
