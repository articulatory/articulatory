...
from articulatory.nets.pytorch_backend.frontends.dnn_beamformer import DNN_Beamformer
from articulatory.nets.pytorch_backend.frontends.dnn_wpe import DNN_WPE
