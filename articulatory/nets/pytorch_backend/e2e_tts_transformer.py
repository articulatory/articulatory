...
from articulatory.nets.pytorch_backend.e2e_tts_tacotron2 import GuidedAttentionLoss
from articulatory.nets.pytorch_backend.e2e_tts_tacotron2 import (
    Tacotron2Loss as TransformerLoss,  # noqa: H301
)
from articulatory.nets.pytorch_backend.nets_utils import make_non_pad_mask
from articulatory.nets.pytorch_backend.tacotron2.decoder import Postnet
from articulatory.nets.pytorch_backend.tacotron2.decoder import Prenet as DecoderPrenet
from articulatory.nets.pytorch_backend.tacotron2.encoder import Encoder as EncoderPrenet
...
from articulatory.nets.pytorch_backend.transformer.embedding import ScaledPositionalEncoding
...
from articulatory.nets.tts_interface import TTSInterface
...
try:
    ...
    class TTSPlot(PlotAttentionReport):
        ...
        def plotfn(
            ...
            from articulatory.nets.pytorch_backend.transformer.plot import (
